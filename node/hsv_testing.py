...
"""
A script to test hsv thresholding on a given image on your computer.

Provided by Miti at https://drive.google.com/file/d/1TwxlC1xWuYTSeDNzzZbTlUwMdr_dqNb7/view
...
img = cv.imread('/home/fizzer/ros_ws/src/my_controller/images/Crosswalk.png',cv.IMREAD_COLOR)
img = cv.medianBlur(img,5)

# Convert BGR to HSV
hsv = cv.cvtColor(img, cv.COLOR_BGR2HSV)

# Adjust these values to test!
uh = 10
us = 255
uv = 255
lh = 0
